...
public enum Symbol
  {
    ...
    // assignment, punctuation, grouping symbols, etc.
    assign(":="),
    leftParen("("),
    rightParen(")"),
    leftBracket("["),
     ...
     * symbol is IntegerRW, BooleanRW, ByteRW, CharRW, or StringRW
     */
    public boolean isPredefinedType()
      {
        return this == IntegerRW || this == BooleanRW || this == ByteRW
            || this == CharRW    || this == StringRW;
      }
