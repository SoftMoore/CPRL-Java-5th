...
public final class Scanner implements Closeable
  {
    ...
    /**
     * Closes the scanner, which closes the underlying source object.
     */
...
// ...
        ...
        catch (ScannerException e)
          {
            ...
            // set symbol to either GETEOF or unknown
    ...
    private Symbol getIdentifierSymbol(String idString)
      {
// ...  Need an efficient search based on the text of the identifier (parameter idString)
      }
    ...
    private void scanHexLiteral() throws ScannerException, IOException
      {
        ...
        assert scanBuffer.charAt(0) == '0' && scanBuffer.charAt(1) == 'X';
// ...
      }
