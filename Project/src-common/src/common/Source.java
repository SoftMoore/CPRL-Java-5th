...
public final class Source implements Closeable
  {
    ...
    // This field has the value GETEOF (-1) when the end of file has been reached.
     ...
     * file.  Returns GETEOF (-1) if the end of file has been reached.
     */
    ...
    /**
     * Closes the source, which closes the underlying source reader.
     */
